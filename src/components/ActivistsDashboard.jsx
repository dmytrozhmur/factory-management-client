...
const columns = [
  ...
  { id: 'id', label: 'Activist Id'},
  { id: 'birthDate', label: 'Date Added'}
];

export default function ActivistsDashboard() {
  ...
  useEffect(() => {
    async function fetchPosts() {
      const response = await fetch('http://localhost:5112/api/Activist')
  ...
  return (
    <>
        <div className='dashboard'>
            <h1 style={{ color: 'blue', marginBottom: '50px', marginTop: 0 }}>Activists</h1>
